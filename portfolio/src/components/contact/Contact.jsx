          ...
          <div className="card p-3 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="mb-0">preethisahu210403@gmail.com</p>
          ...
          <div className="card p-3 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p className="mb-0">9441141053</p>
                <a href="https://wa.me/9441191053" className="stretched-link text-decoration-none">
                  Write me →
                </a>
              </div>
            </div>
          ...
          <div className="card p-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <a href="https://www.linkedin.com/in/preethi-sahu-834305246?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="stretched-link text-decoration-none">
                  Write me →
                </a>
              </div>
            </div>
